      ...
      <Box component="ol" sx={{ pl: 3, m: 0, "& li": { mb: 0.5 } }}>
        <li>
          <Typography variant="body2">
            <strong>Choose a lattice:</strong> Choose a Preset Lattice or build your own by adding labels and ≤ relations
          </Typography>
        </li>
        <li>
          <Typography variant="body2">
        ...
        <li>
          <Typography variant="body2">
            <strong>Model flows:</strong> then, you can map (monad transformation) or combine two values—label to find their <strong>join (lub)</strong>.
          </Typography>
        </li>
        <li>
          <Typography variant="body2">
            <strong>Try outputs:</strong> Create sinks with target labels and click write. A write is permitted iff <code>leq(ℓv, ℓs)</code> holds.
          </Typography>
        </li>
        <li>
          <Typography variant="body2">
